...
var decorator_annotator_2 = require("./decorator-annotator");
exports.convertDecorators = decorator_annotator_2.convertDecorators;
var modules_manifest_1 = require("./modules_manifest");
exports.ModulesManifest = modules_manifest_1.ModulesManifest;
var transformer_1 = require("./transformer");
exports.emitWithTsickle = transformer_1.emitWithTsickle;
exports.mergeEmitResults = transformer_1.mergeEmitResults;
...
var AnnotatorFeatures;
(function (AnnotatorFeatures) {
    AnnotatorFeatures[AnnotatorFeatures["LowerDecorators"] = 1] = "LowerDecorators";
    /**
     ...
     */
    AnnotatorFeatures[AnnotatorFeatures["FilterTypesInExportStart"] = 2] = "FilterTypesInExportStart";
    /**
     ...
     * This flag will be removed and always set once we drop the on transformer version of tsickle.
     */
    AnnotatorFeatures[AnnotatorFeatures["TypeDefReexportForInterfaces"] = 8] = "TypeDefReexportForInterfaces";
    AnnotatorFeatures[AnnotatorFeatures["Default"] = 0] = "Default";
    AnnotatorFeatures[AnnotatorFeatures["Transformer"] = 11] = "Transformer";
})(AnnotatorFeatures = exports.AnnotatorFeatures || (exports.AnnotatorFeatures = {}));
/**
...
var ClosureRewriter = (function (_super) {
    ...
    function ClosureRewriter(typeChecker, file, host, options, sourceMapper) {
    ...
    ClosureRewriter.prototype.newTypeTranslator = function (context) {
        var _this = this;
        var translator = new typeTranslator.TypeTranslator(this.typeChecker, context, this.options.typeBlackListPaths, this.symbolsToAliasedNames);
...
var Annotator = (function (_super) {
    ...
    function Annotator(typeChecker, file, host, options, tsHost, tsOpts, sourceMapper, features) {
        if (features === void 0) { features = AnnotatorFeatures.Default; }
        var _this = _super.call(this, typeChecker, file, host, options, sourceMapper) || this;
        _this.tsHost = tsHost;
        _this.tsOpts = tsOpts;
    ...
    Annotator.prototype.maybeProcess = function (node) {
        ...
        switch (node.kind) {
            ...
            case ts.SyntaxKind.ImportDeclaration:
                (_a = this.importedNames).push.apply(_a, decorator_annotator_1.collectImportedNames(this.typeChecker, node));
            ...
            case ts.SyntaxKind.ElementAccessExpression:
                ...
                if (!quotedPropSym)
                    return false;
                var declarationHasQuotes = !quotedPropSym.declarations || quotedPropSym.declarations.some(function (decl) {
                    if (!decl.name)
                        return false;
    ...
    Annotator.prototype.visitClassDeclaration = function (classDecl) {
        ...
        if (this.features & AnnotatorFeatures.LowerDecorators) {
            this.currentDecoratorConverter =
                new decorator_annotator_1.DecoratorClassVisitor(this.typeChecker, this, classDecl, this.importedNames);
        }
        ...
        if (docTags.length > 0)
            this.emit(jsdoc.toString(docTags));
        decorator_annotator_1.visitClassContentIncludingDecorators(classDecl, this, this.currentDecoratorConverter);
...
function annotate(typeChecker, file, host, options, tsHost, tsOpts, sourceMapper, features) {
...
function writeExterns(typeChecker, file, host, options) {
    if (options === void 0) { options = {}; }
