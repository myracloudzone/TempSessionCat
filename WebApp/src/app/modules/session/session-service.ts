...
export class DataService {
    ...
    getSessionDataByTrack(params) {
        return this.http.get(this.url+'/getSessionsByTrackAndTime'+ '?' + params.toString(), { observe: 'response' });
    }
    ...
    getDistinctDatesForCalendar() {
        return this.http.get(this.url+'/distinctDatesForCalendar', { observe: 'response' });
    }
