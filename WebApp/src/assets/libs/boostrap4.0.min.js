...
+function() {
        ...
        T=function() {
            ...
            h.prototype._keydown=function(t) {
                if(!/input|textarea/i.test(t.target.tagName))switch(t.which) {
                    case d: t.preventDefault(), this.prev();
                    break;
                    case f: t.preventDefault(), this.next();
                    break;
                    default: return
                }
            }
        ...
        m=function() {
            ...
            e._clearMenus=function(n) {
                if(!n||n.which!==f) {
                    ...
                    for(var o=t.makeArray(t(p.DATA_TOGGLE)), r=0;
                    r<o.length;
                    r++) {
    ...
    function(t) {
        ...
        function() {
            for(var e=t.makeArray(t(g.DATA_SPY)), n=e.length;
            n--;
            ) {
                var i=t(e[n]);
